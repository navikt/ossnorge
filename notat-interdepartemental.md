...
**Tiltak:**
- **Tilskuddsordning**: En tverr-offentlig pott for økonomisk støtte til kritiske åpen kildekode-prosjekter som norsk offentlig sektor er avhengig av. Relativt små beløp kan sikre stabiliteten i programvare vi allerede bruker.
- **Bidrag fra ansatte**: Utviklere i offentlig sektor bør kunne bruke deler av arbeidstiden (f.eks. 5%) til å bidra med kode og vedlikehold tilbake til åpen kildekode-prosjekter de bruker i det daglige.
